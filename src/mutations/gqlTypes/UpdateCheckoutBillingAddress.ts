...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_shippingMethods_price {
  __typename: "Money";
  /**
   * Currency code.
   */
...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_shippingMethods {
   ...
   */
  price: UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_shippingMethods_price;
}
...
export interface UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout {
   ...
   */
  shippingMethods: (UpdateCheckoutBillingAddress_checkoutBillingAddressUpdate_checkout_shippingMethods | null)[];
  /**
