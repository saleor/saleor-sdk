...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingMethods_price {
  __typename: "Money";
  /**
   * Currency code.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingMethods {
   ...
   */
  price: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingMethods_price;
}
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout {
   ...
   */
  shippingMethods: (AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingMethods | null)[];
  /**
