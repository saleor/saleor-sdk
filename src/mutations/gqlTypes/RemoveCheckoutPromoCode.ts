...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_shippingMethods_price {
  __typename: "Money";
  /**
   * Currency code.
   */
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_shippingMethods {
   ...
   */
  price: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_shippingMethods_price;
}
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout {
   ...
   */
  shippingMethods: (RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_shippingMethods | null)[];
  /**
