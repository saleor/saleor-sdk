...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingMethods_price {
  __typename: "Money";
  /**
   * Currency code.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingMethods {
   ...
   */
  price: CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingMethods_price;
}
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout {
   ...
   */
  shippingMethods: (CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingMethods | null)[];
  /**
