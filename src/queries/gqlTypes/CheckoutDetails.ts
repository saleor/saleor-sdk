...
export interface CheckoutDetails_checkout_shippingMethods_price {
  __typename: "Money";
  /**
   * Currency code.
   */
...
export interface CheckoutDetails_checkout_shippingMethods {
   ...
   */
  price: CheckoutDetails_checkout_shippingMethods_price;
}
...
export interface CheckoutDetails_checkout {
   ...
   */
  shippingMethods: (CheckoutDetails_checkout_shippingMethods | null)[];
  /**
